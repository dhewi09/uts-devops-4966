pipeline {
    ...
    environment {
        ...
        DEPLOY_HOST = "18.143.65.135"  // Ganti dengan IP instance AWS-mu
        SSH_CREDENTIALS_ID = "dhewi_shh"  // ID credential SSH di Jenkins
        APP_DIR = "/home/ec2-user/app/uts-devops-4966"
        GIT_REPO = "https://github.com/dhewi09/uts-devops-4966.git"
    }
